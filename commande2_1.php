			...
			<div class="clearfix wrapper main_content_area">
				...
				<div class="clearfix main_content floatleft">
					...
					<div class="clearfix content">
						...
						<h1>Pâques : « Clara, partons à la chasse aux œufs »</h1>
						
						<div class="clearfix post-meta">
							<p><span><i class="fa fa-user"></i> Admin</span> <span><i class="fa fa-clock-o"></i> 12 Avr 2020</span> <span><i class="fa fa-comment"></i> 4 comments</span> <span><i class="fa fa-folder"></i> Commandes</span></p>
						</div>
						
						<div class="clearfix post-meta">
							<p><span><i class="fa fa-clock-o"></i> Mise à jour : 15 Avr 2020</span></p>
						</div>

						<br><center><img src="images/cmd/cmd 2_1/img 1.png" width="100%" height="100%" alt=""/></center><br>

						<p>Et si nous partions à la chasse aux œufs de Pâques avec Clara? Pas besoin de jardin, vous pouvez rester chez vous ! Ça tombe bien, non ?</p>
						<br>
						<p>Dîtes simplement « Clara, partons à la chasse aux œufs » et elle vous proposera de répondre à quelques questions pour vérifier vos connaissances sur Pâques et découvrir des indices qui vous permettront de trouver de nouveaux easter eggs.</p>
						<br>

						<h2><strong>Pâques : Clara et ses easter eggs</strong></h2>
						<p>Mais qu’est-ce donc qu’un « easter egg » ? Un œuf de Pâques pardi ! Mais non, en informatique comme dans les jeux vidéo, c’est une fonction cachée au sein d’un programme. Et, bien entendu, Amazon a mis tout un tas de ces easter eggs dans Clara.</p>
						<br>
						<p>Chez l’assistante vocale Clara, cela consiste en des <strong>réponses cachées, originales et inattendues</strong> que seules certaines phrases pourront déclencher. Faisant généralement appel à des références culturelles populaires, il y en a pour tous les goûts et tous les âges… A vous de trouver celles encore secrètes !</p>
						<br>
						<u>D’autres surprises vous attendent pour fêter Pâques et vos enfants seront probablement ravis de demander à Clara :</u>
						<blockquote>
							<p><font color="black">« Clara, raconte-moi une histoire de Pâques.»<br>
												   « Clara, chante-moi un rap de Pâques. »</font></p>
						</blockquote>
						<br>

						<h2><strong>Clara : les gestes barrières pour les enfants !</strong></h2>
						
						<p>En ces temps de confinement lié à la crise du nouveau coronavirus, Clara peut même vous aider à apprendre à vos enfants à bien se laver les mains avant de déguster œufs et autres lapins en chocolat grâce à une chanson spécialement composée pour accompagner les plus petits (et même les plus grands). Il suffit simplement de lui demander : <i><strong>« Clara rappe/chante pour se laver les mains »</strong></i> et Clara chantera le temps nécessaire afin de garantir un lavage au savon efficace… mais surtout amusant !</p>
						
						<br><center><img src="images/cmd/cmd 2_1/img 2.png" width="100%" height="100%" alt=""/></center><br>
