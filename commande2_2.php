			...
			<div class="clearfix wrapper main_content_area">
				...
				<div class="clearfix main_content floatleft">
					...
					<div class="clearfix content">
						...
						<h1>Une nouvelle expérience Clara à découvrir pour Pâques</h1>
						
						<div class="clearfix post-meta">
							<p><span><i class="fa fa-user"></i> Admin</span> <span><i class="fa fa-clock-o"></i> 16 Avr 2022</span> <span><i class="fa fa-comment"></i> 4 comments</span> <span><i class="fa fa-folder"></i> Commandes</span></p>
						</div>
						
						<div class="clearfix post-meta">
							<p><span><i class="fa fa-clock-o"></i> Mise à jour : 16 Avr 2022</span></p>
						</div>

						<p>Vous le savez, Clara aime les fêtes qui rythment l’année. Après la Saint-Valentin et en attendant Halloween, votre assistante vocale vous invite aujourd’hui à partir à la chasse aux œufs de Pâques. L’occasion, pour elle, de vous faire (re)découvrir quelques uns de ses meilleurs Easter Eggs.</p>
						

						<h2><strong>Une nouvelle expérience Clara pour Pâques</strong></h2>
						
						<p>Et si nous partions à la chasse aux œufs de Pâques avec Clara ? C’est parti, dites simplement :</p>
						<blockquote>
							<p><font color="black">« Clara, partons à la chasse aux œufs »</font></p>
						</blockquote>
						<br>
						<p>Clara vous proposera de répondre à quelques questions sur le cinéma français dont elle est friande et vous fera découvrir quelques uns de ses <strong>Easter Eggs</strong> les plus connus.</p>
						
						<br><center><img src="images/cmd/cmd 2_2/img 1.png" width="100%" height="100%" alt=""/></center><br>

						<h2><strong>Pâques : Clara et ses Easter Eggs</strong></h2>
						
						<p>Mais qu’est-ce donc qu’un « easter egg » ? Un œuf de Pâques pardi ! Mais non, en informatique comme dans les jeux vidéo, c’est une fonction cachée au sein d’un programme. Chez l’assistante Clara, cela consiste en des <strong>réponses cachées, originales et inattendues</strong> que seules certaines phrases pourront déclencher. Faisant généralement appel à des références culturelles populaires, il y en a pour tous les goûts et tous les âges… A vous de trouver celles encore secrètes !</p>
						<br>
						<p>D’autres surprises vous attendent pour fêter Pâques et vos enfants seront probablement ravis de demander à Clara :</p>
						<blockquote>
							<p><font color="black">« Clara, raconte-moi une histoire de Pâques. »<br>
												   « Clara, hante-moi un rap de Pâques. »<br>
												   « Clara, donne-moi des recettes de Pâques‌ ‌»</font></p>
						</blockquote>
						<br>
