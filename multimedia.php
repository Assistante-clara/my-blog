			...
			<div class="clearfix wrapper main_content_area">
				...
				<div class="clearfix main_content floatleft">
					...
					<div class="clearfix content">
						<div class="content_title"><h2>Multimédia</h2></div>
						
						<div class="clearfix single_work_container">
							<div class="clearfix single_work">
								<iframe width="340" height="240" src="https://www.youtube.com/embed/-SVzSXtb15k" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
								</iframe>
 							<h2>Installation et réglages de base</h2>
								<a href="https://www.youtube.com/embed/-SVzSXtb15k">
								<p class="caption">Lien de la vidéo.</p></a>
							</div>
